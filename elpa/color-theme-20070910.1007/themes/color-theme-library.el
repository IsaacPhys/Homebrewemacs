...
Green on black, includes font-lock, show-paren, and ediff."
  ...
  (color-theme-install
   '(color-theme-oswald
    ...
    (helm-ff-directory ((t (:background "black" :foreground "brightred"))))
    (helm-selection ((t (:background "brightblue" :distant-foreground "black"))))
    (helm-source-header ((t (:background "brightgreen" :foreground "black" :weight bold :height 1.3 :family "Sans Serif"))))
    ...
    (font-latex-math-face ((t (:foreground "DeepSkyBlue2"))))
    ...
    (italic ((t (:italic t))))
    (font-lock-constant-face ((t (:foreground "brightgreen" :slant italic))))
    (font-lock-preprocessor-face ((t (:foreground "red" :slant italic))))
    (font-lock-string-face ((t (:foreground "green" :slant italic))))
    (font-lock-type-face ((t (:foreground "color-27" :slant italic))))
    (font-lock-variable-name-face ((t (:foreground "brightred" :underline t))))
    (helm-ff-directory ((t (:background "black" :foreground "brightred"))))
    (helm-selection ((t (:background "brightblue" :distant-foreground "black"))))
    (helm-source-header ((t (:background "brightgreen" :foreground "black" :weight bold :height 1.3 :family "Sans Serif"))))
    (modeline ((t (:background "green" :foreground "black"))))
    (modeline-buffer-id ((t (:background "gray60" :foreground "black"))))
